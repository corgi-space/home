...
function Home() {
	return (
		<div className="box-border h-full bg-[url('https://n.sinaimg.cn/sinakd10101/600/w1920h1080/20220218/e168-9cfbdc061c67828fb5a639e3369aec57.jpg')] bg-cover bg-center p-4">
